...
public class DbConnector {
     ...
     */
    private int countAllRecordsByType(String tableName, String itemType) {
        return mDB.query(tableName, null,
     ...
     */
    public boolean isItemDuplicate(String bcode){
        return mDB.query(TABLE_KITS, null, "barcode LIKE ?", new String[]{bcode}, null, null, null)
                .getCount() != 0;
    }
     ...
     *
     * @param kit the new Kit object to write.
     * @return true if update was successful.
     */
    public boolean editItem(Kit kit){
     ...
     *
     * @param kit Kit object to write.
     * @param tableName Name of the table.
     * @return local ID of new record.
     */
    public long addItem(Kit kit, String tableName) {
        ContentValues cv = new ContentValues();
    ...
    public ArrayList<Kit> filteredKits(String itemType, String category, String sortBy) {
        ...
        switch (category) {
            ...
            case MyConstants.CODE_P_OTHER:
                having = DbConnector.COLUMN_CATEGORY + " = '" + MyConstants.CODE_P_OTHER + "'";
                break;
            default:
                having = null;
                break;
...
//    }
    ...
    /**
     * Method for receiving array of brand names ordered by quantity of kits in local DB.
     *
     * @return ordered array of brands names.
     */
    public String[] getSortedBrandNames() {
...
//            return result;
    ...
    /**
     * Method for preparing Kit objects from Cursor.
     *
     * @param cursor data from DB.
     * @return list of Kit objects.
     */
...
// TODO: 17.07.2018 добавить иконки для красок
        ...
        firstItem.setQuantity(countAllRecordsByType(TABLE_KITS, workMode));
        list.add(firstItem);
     ...
     */
    public void addPaint(ContentValues cv) {
     ...
     */
    public void editPaint(long id, ContentValues cv) {
